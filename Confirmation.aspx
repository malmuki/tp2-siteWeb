...
<body>
    ...
    <div>
        <h1>Merci <asp:label runat="server" ID="lblNomEtPrenom"></asp:label>!</h1><br />
        <asp:Label runat="server" ID="lblMatricule"></asp:Label><br />
        <h2>Terrain Réservé</h2><br />
        Terrain de <asp:Label runat="server" ID="lblSportTerrain"></asp:Label><br />
        Réservé pour le <asp:Label runat="server" ID="lblDate"></asp:Label> 
        de <asp:Label runat="server" ID="lblHeureDebut"></asp:Label> 
